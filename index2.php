...
<html lang="en">
  <head>
    ...
    <title>SEC digital calendar for Outlook, Google Calendar, iCal, etc. | an unofficial resource for the Scottish Episcopal Church</title>
  ...
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
    <a class="navbar-brand" href="#">SEC digital calendar</a>
      ...
      <div class="carousel-item active">
        <div class="container">
          <div class="carousel-caption text-left">
            <h1>Columban.</h1>
            <p>Bishop, 615 [6] White</p>
            <p class="badge badge-dark">Thursday 21 November 2019</p>
          </div>
        </div>
      </div>
